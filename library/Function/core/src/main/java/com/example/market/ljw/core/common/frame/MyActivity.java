...
import com.example.market.ljw.core.utils.InflateUtil;
import com.example.market.ljw.core.utils.Log;
import com.example.market.ljw.core.utils.view.MyProgressDialog;
...
public class MyActivity extends Fragment implements IMyActivity{
    ...
    public void execute(String finalUrl, Map<String, Object> paramMap,
                        Class dataClass, HttpGroup.OnEndListener onEndListener,HttpGroup.OnParseListener onParseListener) {
        HttpGroup httpGroup = getHttpGroupaAsynPool();
        HttpSetting httpSetting = new HttpSetting();
     ...
     */
    public void execute(String finalUrl, Map<String, Object> paramMap,
                        Class dataClass, HttpGroup.OnEndListener onEndListener,HttpGroup.OnParseListener onParseListener,int CACHE_MODE) {
        HttpGroup httpGroup = getHttpGroupaAsynPool();
        HttpSetting httpSetting = new HttpSetting();
        httpSetting.setFinalUrl(finalUrl);
        httpSetting.setParamMaps(paramMap);
