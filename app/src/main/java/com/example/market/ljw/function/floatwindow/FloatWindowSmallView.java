...
public class FloatWindowSmallView extends LinearLayout {
    ...
    public FloatWindowSmallView(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.layout_ljw_float, this);
        View view = findViewById(R.id.ljw_float_img);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (Math.abs(xDownInScreen - xInScreen) < ErrorValue && Math.abs(yDownInScreen - yInScreen) < ErrorValue) {
                    ...
                    //判断最后滑动的区域
                    //如果是左边，则停靠在左边
                    if (xInScreen < getScreenWidth() / 2) {
                        xInScreen = 0;
                        updateViewPosition();
                    } else {
                        //否则在右边
                        xInScreen = getScreenWidth();
                        updateViewPosition();
                    }
